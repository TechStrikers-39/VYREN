...
export const HeroSection: React.FC = () => {
  return (
    <section className="w-full min-h-[calc(100vh-4rem)] flex flex-col justify-center bg-surface-alt py-12 lg:py-16 border-b border-border relative overflow-hidden" id="overview">
        ...
        <div className="grid grid-cols-1 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[58px] leading-[1.1] font-bold text-text-primary tracking-[-0.03em] mb-6 text-center mx-auto">
              ...
              <span className="text-primary-navy">Intelligence.</span>
            </h1>

            <p className="text-lg sm:text-xl text-text-secondary max-w-2xl mb-8 leading-relaxed font-normal text-center mx-auto">
              Understand what you know, identify what you need, and get a learning path that adapts as you grow.
            </p>
