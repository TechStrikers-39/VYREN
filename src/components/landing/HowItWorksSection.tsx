      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-2xl mb-14">
          ...
          <p className="text-base sm:text-lg text-text-secondary leading-relaxed">
            From diagnostic measurement to proven capability. A living feedback cycle that continuously re-evaluates trajectories and updates curricula.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-5">
          ...
          <div className="bg-surface p-6 rounded-xl border border-border shadow-sm flex flex-col justify-between hover:border-action-blue transition-all duration-200">
            <div>
              ...
              <h3 className="text-base font-bold text-text-primary mb-2">Assess</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
                Adaptive baseline diagnostic adjusts question difficulty on-the-fly using Item Response Theory.
              </p>
            </div>
          ...
          <div className="bg-surface p-6 rounded-xl border border-border shadow-sm flex flex-col justify-between hover:border-action-blue transition-all duration-200">
            <div>
              ...
              <h3 className="text-base font-bold text-text-primary mb-2">Identify Gaps</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
                Algorithmic delta detection extracts exact capability deficits against national cadre benchmarks.
              </p>
            </div>
            <div className="mt-6 pt-3 border-t border-border flex items-center gap-1.5 text-xs text-text-muted font-mono">
          ...
          <div className="bg-surface p-6 rounded-xl border border-border shadow-sm flex flex-col justify-between hover:border-action-blue transition-all duration-200">
            <div>
              ...
              <h3 className="text-base font-bold text-text-primary mb-2">Recommend</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
                Precision learning modules synthesized directly targeting the diagnosed deficiency.
              </p>
            </div>
            <div className="mt-6 pt-3 border-t border-border flex items-center gap-1.5 text-xs text-text-muted font-mono">
          ...
          <div className="bg-surface p-6 rounded-xl border border-border shadow-sm flex flex-col justify-between hover:border-action-blue transition-all duration-200">
            <div>
              ...
              <h3 className="text-base font-bold text-text-primary mb-2">Learn</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
                Targeted skill acquisition through micro-pedagogical casework and interactive validation notebooks.
              </p>
            </div>
            <div className="mt-6 pt-3 border-t border-border flex items-center gap-1.5 text-xs text-text-muted font-mono">
          ...
          <div className="bg-surface p-6 rounded-xl border border-border border-t-4 border-t-primary-navy shadow-sm flex flex-col justify-between hover:border-border-strong transition-all duration-200">
            <div>
              ...
              <h3 className="text-base font-bold text-text-primary mb-2">Improve</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
                Score recalibration and continuous growth. Verification feeds immediately into the next cycle.
              </p>
            </div>
